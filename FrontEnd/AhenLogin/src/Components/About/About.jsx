...
<div className="welcome text-4xl md:text-4xl font-bold text-center">
          <h3>Welcome to Ahen Driving School</h3>
            ...
            <div className="mt-6 space-y-8">
              <div className="cards">
                <div className="card red border border-white">
                ...
                <div className="card blue border border-white">
                ...
                <div className="card green border border-white">
                  <h3 className="tip text-white">Solutions We Provide</h3>
                  <p className="second-text text-justify text-white">
                    Ahen addresses these problems, making it India's next
                ...
                <div className="card orange border border-white">
